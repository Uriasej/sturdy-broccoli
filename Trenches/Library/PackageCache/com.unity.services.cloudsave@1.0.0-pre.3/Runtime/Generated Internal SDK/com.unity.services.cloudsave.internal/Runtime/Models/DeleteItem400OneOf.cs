...
{
    /// <summary>
    /// DeleteItem400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(DeleteItem400OneOfJsonConverter))]
    [DataContract(Name = "DeleteItem400OneOf")]
    internal class DeleteItem400OneOf : IOneOf
    {
        ...
        /// <summary>DeleteItem400OneOf Constructor</summary>
        /// <param name="value">The value as an object for DeleteItem400OneOf</param>
        /// <param name="type">The type for DeleteItem400OneOf</param>
        public DeleteItem400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of DeleteItem400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of DeleteItem400OneOf</returns>
        public static DeleteItem400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("DeleteItem400OneOf", DiscriminatorKey);
                }
        ...
        private static DeleteItem400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new DeleteItem400OneOf(actualObject, concreteType);
        }

        private static DeleteItem400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new DeleteItem400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for DeleteItem400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class DeleteItem400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return DeleteItem400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
