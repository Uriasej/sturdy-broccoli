...
{
    /// <summary>
    /// GetKeys400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetKeys400OneOfJsonConverter))]
    [DataContract(Name = "GetKeys400OneOf")]
    internal class GetKeys400OneOf : IOneOf
    {
        ...
        /// <summary>GetKeys400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetKeys400OneOf</param>
        /// <param name="type">The type for GetKeys400OneOf</param>
        public GetKeys400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetKeys400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetKeys400OneOf</returns>
        public static GetKeys400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetKeys400OneOf", DiscriminatorKey);
                }
        ...
        private static GetKeys400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetKeys400OneOf(actualObject, concreteType);
        }

        private static GetKeys400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetKeys400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetKeys400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetKeys400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetKeys400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
