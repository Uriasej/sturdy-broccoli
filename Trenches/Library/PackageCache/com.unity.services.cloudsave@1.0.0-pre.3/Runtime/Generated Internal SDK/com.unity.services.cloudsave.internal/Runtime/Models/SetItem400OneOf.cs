...
{
    /// <summary>
    /// SetItem400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(SetItem400OneOfJsonConverter))]
    [DataContract(Name = "SetItem400OneOf")]
    internal class SetItem400OneOf : IOneOf
    {
        ...
        /// <summary>SetItem400OneOf Constructor</summary>
        /// <param name="value">The value as an object for SetItem400OneOf</param>
        /// <param name="type">The type for SetItem400OneOf</param>
        public SetItem400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of SetItem400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of SetItem400OneOf</returns>
        public static SetItem400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("SetItem400OneOf", DiscriminatorKey);
                }
        ...
        private static SetItem400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new SetItem400OneOf(actualObject, concreteType);
        }

        private static SetItem400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new SetItem400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for SetItem400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class SetItem400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return SetItem400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
